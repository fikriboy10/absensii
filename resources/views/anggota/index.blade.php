...
<div class="page-header d-print-none">
  ...
  <div class="page-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="#" class="btn btn-primary" id="btnTambahanggota">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <input type="text" name="nama_anggota" id="nama_anggota" class="form-control" placeholder="Nama Anggota" value="{{ Request('nama_anggota') }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                            ...
                            <div class="col-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                        $path = Storage::url('uploads/anggota/'.$d->foto);
                                        @endphp
                                        <tr>
                                            ...
                                            <td>
                                                @if (empty($d->foto))
                                                <img src="{{ asset('assets/img/invis-user.png') }}" class="avatar" alt="">
                                                @else
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <form action="/anggota/{{ $d->nis }}/delete" method="POST" style="margin-left:5px">
                                                        @csrf
    ...
    <div class="modal modal-blur fade" id="modal-inputanggota" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/anggota/store" method="POST" id="frmAnggota" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nis" class="form-control" placeholder="Nis" name="nis">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="kelas_jurusan" value="" class="form-control" name="kelas_jurusan" placeholder="Kelas/Jurusan">
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    {{-- Modal Edit --}}
    <div class="modal modal-blur fade" id="modal-editanggota" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
<script>
    $(function() {
        ...
        $("#frmAnggota").submit(function() {
    var nis = $("#nis").val();
    var nama_lengkap = $("#nama_lengkap").val();
    var kelas_jurusan = $("#kelas_jurusan").val();  // Ganti id dari kelas/jurusan menjadi kelas_jurusan
    var no_hp = $("#no_hp").val();
    ...
    if (nis == "") {
        ...
        return false;
    } else if (kelas_jurusan == "") {
        Swal.fire({
            title: 'Warning!',
            text: 'Kelas/Jurusan Harus Diisi!',
            icon: 'warning',
            confirmButtonText: 'Ok'
        }).then((result) => {
            $("#kelas_jurusan").focus();
