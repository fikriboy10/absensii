    ...
    <script>
        $(function(){
            $("#getdata").click(function(e){
                ...
                var bulan = $("#bulan").val(); // Selektor ID menggunakan #
                var tahun = $("#tahun").val(); // Selektor ID menggunakan #
                ...
                $.ajax({
                    ...
                    success: function(respond) {
                        $("#showhistori").html(respond); // Selektor ID menggunakan #
                    }
                });
            }); 
        });
